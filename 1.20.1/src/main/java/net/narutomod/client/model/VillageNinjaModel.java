...
public final class VillageNinjaModel extends EntityModel<NinjaMobEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            NarutomodMod.location("village_ninja_legacy"),
            "main"
    );
    ...
    public VillageNinjaModel(ModelPart root) {
