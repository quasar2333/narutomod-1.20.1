...
public final class LightningBeastModel extends EntityModel<LightningBeastEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
        NarutomodMod.location("lightning_beast"),
        "main"
    );
    ...
    public LightningBeastModel(ModelPart root) {
        this.root = root;
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(0, 0)
                .addBox(-2.0F, -3.0F, -2.0F, 6.0F, 6.0F, 4.0F, CubeDeformation.NONE)
                .texOffs(0, 10)
                .addBox(-0.5F, 0.0F, -5.0F, 3.0F, 3.0F, 4.0F, CubeDeformation.NONE)
                .texOffs(16, 14)
                .addBox(-2.0F, -5.0F, 0.0F, 2.0F, 2.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(16, 14)
                .addBox(2.0F, -5.0F, 0.0F, 2.0F, 2.0F, 1.0F, CubeDeformation.NONE),
    ...
    @Override
    public void setupAnim(LightningBeastEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
