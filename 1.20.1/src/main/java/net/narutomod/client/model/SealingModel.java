...
public final class SealingModel extends EntityModel<SealingEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            NarutomodMod.location("sealing_legacy"),
            "main"
    );

    private final ModelPart main;

    public SealingModel(ModelPart root) {
        this.main = root.getChild("bb_main");
    }

    public static LayerDefinition createBodyLayer() {
        return LegacyModelLayerDefinitions.EntitySealing_ModelSeal_271();
    }

    @Override
    public void setupAnim(SealingEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks,
