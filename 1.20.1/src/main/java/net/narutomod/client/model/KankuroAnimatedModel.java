...
public final class KankuroAnimatedModel extends EntityModel<NinjaMobEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
        NarutomodMod.location("kankuro_animated_legacy"),
        "main"
    );
    ...
    public KankuroAnimatedModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        body.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(24, 0)
                .addBox(-3.0F, 3.0F, 11.0F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.1F))
                .texOffs(24, 0)
                .addBox(-3.0F, 6.0F, 11.0F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.1F))
                .texOffs(24, 0)
                .addBox(-3.0F, 9.0F, 11.0F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.1F)),
    ...
    public void setupAnim(NinjaMobEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.rightLeg.zRot = 0.0349F;
        this.leftLeg.zRot = -0.0349F;
