...
public final class TemariModel extends EntityModel<NinjaMobEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            NarutomodMod.location("temari_legacy"),
            "main"
    );
    ...
    public TemariModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(32, 0)
                        .addBox(-4.0F, -32.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.2F))
                        .texOffs(32, 0)
                        .addBox(-4.0F, -32.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.4F))
                        .texOffs(32, 0)
                        .addBox(-4.0F, -32.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.6F)),
