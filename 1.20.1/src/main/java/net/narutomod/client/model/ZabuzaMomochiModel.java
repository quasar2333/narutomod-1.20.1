...
public final class ZabuzaMomochiModel extends EntityModel<NinjaMobEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            NarutomodMod.location("zabuza_momochi_legacy"),
            "main"
    );
    ...
    public ZabuzaMomochiModel(ModelPart root) {
