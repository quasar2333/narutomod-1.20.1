...
public final class HakuModel extends EntityModel<HakuEntity> implements ArmedModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            NarutomodMod.location("haku_legacy"),
            "main"
    );
    ...
    public HakuModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(HakuEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    private void applyHeldItemPose(HakuEntity entity) {
