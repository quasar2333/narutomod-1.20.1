...
public final class SakuraHarunoModel extends EntityModel<SakuraHarunoEntity> implements ArmedModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            NarutomodMod.location("sakura_haruno_legacy"),
            "main"
    );
    ...
    public SakuraHarunoModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(SakuraHarunoEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    private void applyHeldItemPose(SakuraHarunoEntity entity) {
