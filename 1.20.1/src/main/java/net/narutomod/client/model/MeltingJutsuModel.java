...
public final class MeltingJutsuModel extends EntityModel<MeltingJutsuEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            NarutomodMod.location("melting_jutsu_legacy"),
            "main"
    );

    private final ModelPart main;

    public MeltingJutsuModel(ModelPart root) {
        this.main = root.getChild("bb_main");
    }

    public static LayerDefinition createBodyLayer() {
        return LegacyModelLayerDefinitions.EntityMeltingJutsu_ModelBlock_239();
    }

    @Override
    public void setupAnim(MeltingJutsuEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks,
