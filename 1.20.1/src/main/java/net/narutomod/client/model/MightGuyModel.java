...
public final class MightGuyModel extends EntityModel<MightGuyEntity> implements ArmedModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            NarutomodMod.location("might_guy_legacy"),
            "main"
    );
    ...
    public MightGuyModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(MightGuyEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    private void applyHeldItemPose(MightGuyEntity entity) {
